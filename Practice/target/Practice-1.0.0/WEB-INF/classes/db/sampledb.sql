CREATE MEMORY TABLE SAMPLE(ID VARCHAR(16) NOT NULL PRIMARY KEY,NAME VARCHAR(50),DESCRIPTION VARCHAR(100),SAMPLING VARCHAR(100),USE_YN CHAR(1),REG_USER VARCHAR(10))
